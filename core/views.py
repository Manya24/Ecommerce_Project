...
@silk_profile(name='index page')
def index(request):
    products = Product.objects.all()
    return render(request, "core/index.html", {"products": products})

@silk_profile(name='orderlist')
...
@silk_profile(name='product desc')
...
def checkout_page(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # Save the checkout address to the database
    ...
    if request.method == "POST":
        try:
            ...
            if result == None:
                ...
                if payment_status and payment_status.get("status") == "captured":
